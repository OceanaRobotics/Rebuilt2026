...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    try {
      swerveDrive = new SwerveParser(directory).createSwerveDrive(Constants.MAX_SPEED, new Pose2d(new Translation2d(Meter.of(15), Meter.of(1)), Rotation2d.fromDegrees(0)));
      ...
      AutoBuilder.configure(
          ...
          () -> {
            ...
            // if (alliance.isPresent()) {
              // return alliance.get() == DriverStation.Alliance.Red;  // These are commented out, since we have added specific autos for each side and do not want it flipping
            // }
            return false;
          },
          this
