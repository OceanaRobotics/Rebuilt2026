...
public class Hopper extends SubsystemBase {
  ...
  /**
   * Run the hopper and kicker system at a given percent
   * @param agitatorPercent - Desired motor percent
   * @param kickerPercent - Desired motor percent
   ...
   * @param agitatorRPM - Desired motor RPM
